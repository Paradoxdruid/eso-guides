...
| ---------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![DPS Logo](./assets/icons/ability_2handed_003_a.png)](./dps.html)<br>[**DPS**](./dps.html)                           | [**DPS Builds and Guides**](./dps.html):<br>I want to see skill bars, subclassing, and commonly worn armor sets to get up and running fast on DPS                                                   |
| [![illustrious](./assets/icons/ability_restorationstaff_004b.png)](./supports.html)<br>[**Supports**](./supports.html) | [**Supports Builds and Guides**](./supports.html):<br>I want to see skill bars, subclassing, and commonly worn armor sets for **Tanks** and **Healers** to get up and running fast on support roles |
| [![charging](./assets/icons/ability_ava_002_b.png)](./rosters.html)<br>[**Rosters**](./rosters.html)                   | [**U49 Trial Rosters**](./rosters.html):<br>I plan to lead a trial, and I'd like a discord-ready roster template with roles, sets, and trial specific roles and group organization                  |
